...
A total of 25 children aged 10--13 participated across three sessions
(Table~\ref{tab:demographics}). The cohort comprised 15 boys and 10 girls,
with most participants aged 10 or 11. 
\begin{table}[t]
\centering
\caption{Demographic breakdown of the 25 children who participated in the data collection phase.}
...
Data were collected over three consecutive Saturday sessions from 9:00 to
12:00 at [blinded]. Each session began with a whole-group introduction to a
...
[81, revisar!!!!] sessions comprising approximately [2,000, revisar!!!]
messages across 4 exercises.
...
Children    & -- & Turns          & -- & Closed \%      & -- \\
Sessions    & -- & Messages       & -- & Abandoned \%   & -- \\
Messages    & -- & Questions      & -- & Active \%      & -- \\
Child msg.  & -- & Duration (min) & -- & Satisf. (1--5) & -- \\
Bit msg.    & -- & Blocks sugg.   & -- &                &    \\
Exercises   & -- &                &    &                &    \\
\bottomrule
\end{tabular}
